      ...
      <div class="form-group">
        <input type="hidden" name="id" value=<%= rs.getString("id")  %> class="form-control"/>
         <input type="hidden" name="userId" value=<%= userId  %> class="form-control"/>
                   <label>id</label>
                  <input type="text" name="bookId" value=<%= rs.getString("id") %> class="form-control">
                    </div>
                                            
                    <div class="form-group">
                        <label>author </label>   <input type="text" name="userId" value=<%= rs.getString("author") %> class="form-control" >
                       
                        </div>
                                            
                        <div class="form-group">
                            <label>Title </label>  <input type="text" name="state" value=<%= rs.getString("title") %> class="form-control">
