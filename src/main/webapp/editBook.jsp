...
%>
 ...
 <form action="" method="post">
     ...
     String b = request.getParameter("b");
      String checkboxResult= request.getParameter("state");
       ...
       while(rs.next()){
        ...
        <input type="hidden" name="id" value=<%= rs.getString("id")  %> class="form-control"/>
                  ...
                  <input type="text" name="title" value=<%= rs.getString("title") %> class="form-control">
                    ...
                    <div class="form-group">
                        <label>Author</label>
                        <input type="text" name="author" value=<%= rs.getString("author") %> class="form-control" >
                        </div>
                        ...
                        <div class="form-group">
                        <label>State</label>						
                        <input type="text" id="status" name="state" value=<%= rs.getString("state") %> class="form-control" >
                        </div> 
 ...
 String d = request.getParameter("state");
     ...
     if(a!=null &&  e!=null && c!=null){
    	 stmt.executeUpdate("UPDATE book_table SET title='"+a+"', author='"+c+"' ,state='"+d+"'  WHERE id= '"+e+"'");
