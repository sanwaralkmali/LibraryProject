...
%>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Password</label>
                             <input type="password" name="password" value=<%= rs.getString("upass") %> class="form-control">
                              </div>
                                            
                            <div class="form-group">
                            <label>Confirm Password</label>
                            <input type="password" name="confirmpassword" value=<%= rs.getString("upass") %> class="form-control" >
                           </div>
 ...
 String d = request.getParameter("confirmpassword");
     if(a!=null &&  b!=null && c!=null && d!=null){
    	 stmt.executeUpdate("UPDATE user_table SET uname='"+a+"', upass='"+c+"', email='"+b+"' WHERE uid= '"+e+"'");
