...
<div id="page-wrapper">
   ...
   MyDb db = new MyDb();
	...
	try {
		...
		ResultSet rs= stmt.executeQuery("SELECT * FROM user_table ORDER BY uid DESC");
		...
		while(rs.next())
		{
			 ...
			 <tr >
			   ...
			   <td> <a href="editUser.jsp?u=<%= rs.getString("uid") %>"> Edit</a> |  </td> 
			   <td> <a href="deleteUser.jsp?u=<%= rs.getString("uid") %>"> Delete | </a>  </td>
			   <td> <a href="detailUser.jsp?u=<%= rs.getString("uid") %>"> Detail </a>  </td>
			 </tr>
			 <%
		}
