...
<div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Borrowed users </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                            <!-- /.panel-heading -->
   ...
   MyDb db = new MyDb();
	...
	try {
		...
		ResultSet rs= stmt.executeQuery("SELECT * FROM borrow_table");
		
		
		//ResultSet rs2 = stmt.executeQuery("SELECT * FROM user_table WHERE uid="+UserId+"");
		//ResultSet rs3 = stmt.executeQuery("SELECT * FROM book_table WHERE id="+BookId+"");
		while(rs.next())
		{
			 %>
